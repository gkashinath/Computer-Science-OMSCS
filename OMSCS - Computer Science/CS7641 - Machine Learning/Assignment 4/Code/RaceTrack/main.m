...
% Solving the MDP
%[V, Policy, g, cpu_time] = mdp_value_iteration(P2, C2, 0.99);
[V, Policy, g, cpu_time] = mdp_policy_iteration(P2, C2, 0.8);

% Q-Learning
%[Q, V, policy, mean_discrepancy] = mdp_Q_learning(P2, C2, 0.99);

%plot(mean_discrepancy);

display ([ 'time: ' num2str(cpu_time,'%10.5e\n') ' iter: ' num2str(g) ] );
